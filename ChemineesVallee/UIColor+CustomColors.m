...
+ (UIColor *)colorWhite {
    return [UIColor colorWithRed:253.0/255.0 green:253.0/255.0 blue:252.0/255.0f alpha:1.0];
}

+ (UIColor *)colorBlack {
    return [UIColor colorWithRed:33.0/255.0 green:33.0/255.0 blue:33.0/255.0f alpha:1.0];
}
